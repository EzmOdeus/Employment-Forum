...
const testimonials: Testimonial[] = [
  {
    id: 1,
    content: "الملتقى التوظيفي كان فرصة ممتازة للتواصل مع الشركات وفهم احتياجات سوق العمل. حصلت على وظيفة من خلال الملتقى العام الماضي وأنا ممتن جداً لهذه الفرصة.",
    name: "أحمد محمود",
  ...
  {
    id: 3,
    content: "كشركة مشاركة، وجدنا الملتقى التوظيفي فرصة ممتازة لاستقطاب المواهب الشابة والتعرف على خريجي الكلية المميزين. نتطلع للمشاركة مرة أخرى هذا العام.",
    name: "محمد خالد",
